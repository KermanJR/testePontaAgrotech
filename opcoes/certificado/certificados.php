      ...
      <form action="?page=certificados_palestrante" method="post" enctype="multipart/form-data" >
        <div class="row">
          <div class="form-group col-md-6">
            Frente:
            <img src="opcoes/certificado/imagens/avalfrente.jpg" width="100%">
          </div>
          <div class="form-group col-md-6">
            Verso:
            <img src="opcoes/certificado/imagens/avalverso.jpg" width="100%">
          </div>
        </div>
        <div class="form-group">
           <label>Texto:</label>
    ...
    <!-- CERTIFICADO PARTICIPAÇÃO -->
      ...
      <form action="?page=certificados_participacao" method="post" enctype="multipart/form-data" >
        <div class="row">
          <div class="form-group col-md-6">
            Frente:
            <img src="opcoes/certificado/imagens/" width="100%">
          </div>
          <div class="form-group col-md-6">
            Verso:
            <img src="opcoes/certificado/imagens/" width="100%">
